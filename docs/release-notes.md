...
Install Athena through its Git-backed skill or plugin source. The concrete installation and
invocation commands depend on the coding harness and are described generically in the root
[`README.md`](../README.md).
